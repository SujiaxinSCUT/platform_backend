...
public interface OrderRepository extends JpaRepository<Order, Integer> {
    ...
    @Query(nativeQuery = true, value = "select system_order.id, system_order.client_name, system_order.supplier_name, system_order.status, system_order.date " +
            ...
            "and if(:start_date != null and :end_date != null, system_order.date between :start_date and :end_date, 1 = 1 ) " +
            "and if(:start_date != null and :end_date = null, system_order.date > :start_date, 1 = 1 ) " +
            "and if(:start_date = null and :end_date != null, system_order.date < :end_date, 1 = 1 ) " +
            "and if(:product_name != null and :product_name != '', product.name like %:product_name%, 1 = 1) ",
            countQuery = "select count(*) from system_order")
